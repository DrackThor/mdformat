First sentence. Second sentence! Third one? Done.
...
Call `a. b` inline and see [the docs](https://example.com/a.b.c) here. Next.

> Quoted text. Wrapped over
> two source lines.

- List item. Second sentence.
