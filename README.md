...
Every rule ships with a golden fixture: an input under `test-cases/inputs/`,
the expected output under `test-cases/expected/`,
and a case pairing them in `test-cases/test-config.yaml`.
